...
issue_candidates ディレクトリに、issue候補の情報を格納してください。issue候補の情報は、Issueに登録する前の、課題の概要、課題の背景、課題の解決方法のアイデア等を記載・蓄積してください。

例: 捕獲した鹿をおいしく食べるにはどうしたらよいか、というissue候補が上がったとして、その情報を格納する場合
